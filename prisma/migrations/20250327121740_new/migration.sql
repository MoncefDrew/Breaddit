...
CREATE TABLE `Rule` (
    ...
    INDEX `Rule_subredditId_idx`(`subredditId`),
    PRIMARY KEY (`id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
-- AddForeignKey
ALTER TABLE `Rule` ADD CONSTRAINT `Rule_subredditId_fkey` FOREIGN KEY (`subredditId`) REFERENCES `Subreddit`(`id`) ON DELETE CASCADE ON UPDATE CASCADE;
